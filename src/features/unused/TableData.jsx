...
import AddCabinForm from '../cabins/AddCabinForm';
import Modal from '../../ui-component/Modal';
import Menu from '../../ui-component/Menu';
import ConfirmDelete from '../../ui-component/ConfirmDelete';
import { deleteCabin, editCabin, openModal } from '../cabins/cabinSlice';
	...
	return (
		<>
			...
			>
				...
				<p>{cabin.discount ? currConverter(discount) : <span>&mdash;</span>}</p>
